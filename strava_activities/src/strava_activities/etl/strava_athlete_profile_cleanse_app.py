...
def main():
    ...
    cleanse_df = raw_df.selectExpr(
        ...
        "trim(athlete_profile:firstname) as first_name",
        "trim(athlete_profile:lastname) as last_name",
        "cast(athlete_profile:badge_type_id as int) as badge_type_id",
        "trim(athlete_profile:bio) as bio",
        "trim(athlete_profile:city) as city",
        "trim(athlete_profile:state) as state",
        "trim(athlete_profile:country) as country",
